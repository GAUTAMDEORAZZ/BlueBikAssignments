...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<myErrorDetails> AccountExceptionHandler(AccountException ee, WebRequest req){
	...
	public ResponseEntity<myErrorDetails> UserExceptionHandler(UserException de, WebRequest req){
